...
4. Edit the variables to fit your pupose
	`age_of_files = 30  # at which age files should be deleted?<br/>
	 working_dir = '/<observed_dir>/'  # which folder should be observed?<br/>
	 ifttt_integration = True  # do you wish to get an notification through IFTTT whenever a file gets deleted?<br/>
	 logging = True  # do you want to have a log file with every action this skript does to your files?<br/>
	 run_ifttt_webhook_name = 'run_dropbox_automatic_deletion'  # Name of your Webhook for notification whenever the scrips runs<br/>
